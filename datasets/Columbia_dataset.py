...
class Columbia_dataset(data.Dataset):
    ...
    def __init__(self, dataset_opt, is_train=True, with_mask=True, splic_only=True, mode="train"):
        super(Columbia_dataset, self).__init__()
        self.is_train = is_train
        self.dataset_opt = dataset_opt
        self.paths_LQ, self.paths_GT = None, None
        self.sizes_LQ, self.sizes_GT = None, None
        self.GT_size = self.dataset_opt['datasets']['train']['GT_size']
        ...
        self.path_root = '/hotdata/Columbia_Uncompressed_Image_Splicing_Detection/'
        ...
        self.paths_GT = GT_path #(GT_path[:num_train_val_split] if self.is_train else GT_path[num_train_val_split:])
    ...
    def __getitem__(self, index):
        ...
        # todo: label 0 means fake 1 means true
        ...
        return img_GT.float(), img_GT.float(), mask.float()
