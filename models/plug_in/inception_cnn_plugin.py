...
class inception_cnn_plugin(GoogLeNet):
    def __init__(self, opt, img_size=512, num_classes:list=[1000,1000], embed_dims=[192,480,528,1024],
        ...
        super(inception_cnn_plugin, self).__init__(num_classes=num_classes)
