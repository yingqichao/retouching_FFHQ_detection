...
class resnet_cnn_plugin(ResNet):
    def __init__(self, opt, img_size=512, num_classes:list=[1000,1000], layers=[3,4,6,3], embed_dims=[128,256, 512, 1024],
        ...
        super(resnet_cnn_plugin, self).__init__(block, layers, 3, num_classes, False, False,32)
