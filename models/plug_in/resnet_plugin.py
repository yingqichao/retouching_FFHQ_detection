...
class resnet_plugin(ResNet):
    def __init__(self, opt, img_size=512, num_classes:list=[1000,1000], layers=[3,4,6,3], embed_dims=[128,256, 512, 1024], num_heads=[8,8,8,8],
        ...
        super(resnet_plugin, self).__init__(block, layers, 3, num_classes, False, False, 32)
        self.opt = opt
