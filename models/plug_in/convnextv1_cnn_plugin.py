...
class convnextv1_cnn_plugin(ConvNeXt):
    def __init__(self, opt, img_size=512, num_classes: list = [1000, 1000], embed_dims=[96, 192, 384, 768],
                 num_heads=[8, 8, 8, 8],
        ...
        super(convnextv1_cnn_plugin, self).__init__(depths=[3, 3, 9, 3], dims=embed_dims, num_classes=num_classes)
