...
class DePatchEmbed(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, out_chans=3, embed_dim=768, norm_layer=None, flatten=True):
        super().__init__()
        ...
        self.proj = nn.Conv2d(embed_dim, out_chans, kernel_size=patch_size, stride=patch_size)
