...
class ShuntedTransformer(nn.Module):
    def __init__(self, img_size=224, patch_size=16, in_chans=3, num_classes:list=[1000], embed_dims=[64, 128, 256, 512],
        ...
        for num_class in num_classes:
            self.head.append(nn.Linear(embed_dims[3], num_class))
...
if __name__ == '__main__':
    model = shunted_b(img_size=448,num_classes=[4,4,4,4])
