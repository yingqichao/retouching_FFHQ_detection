...
class SwinTransformer(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes: list=[1000],
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        nin, nout = 3, 1
        X = torch.randn(1,nin, 448,448).cuda()
        ...
        model = SwinTransformer(448,num_classes=[1000,1000,1000,1000]).cuda()
